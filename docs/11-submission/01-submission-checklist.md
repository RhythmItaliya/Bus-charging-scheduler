...
- [ ] `pytest` is fully green (**206 tests**, ~1.2 s)
...
- [ ] `docs/` tree is included in the repo (all 11 sections, all Mermaid diagrams rendered)
...
- Brief build notes: *Python stdlib engine, Streamlit UI, 206 tests across 9 modules, 5 scenarios, all invariants validated post-schedule*
